...
export default function Home() {
  ...
  return (
    <div className="bg-[var(--main-color)] text-white flex flex-col gap-5 justify-center items-center h-screen relative">
      ...
      <div className="w-screen h-screen flex mobile:flex-row flex-col-reverse mobile:justify-between justify-center mobile:items-center items-start px-8 space-y-3 mobile:gap-0 gap-10">
        <div className="flex flex-col justify-between items-start space-y-3">
          <div className="flex flex-col justify-start space-y-2">
            <h2 className="mobile:text-3xl text-2xl font-bold">
              Peer-to-Peer Video Calling <br /> with WebRTC
            </h2>
            <p className="mobile:text-base text-sm">A basic demonstration of WebRTC&apos;s capabilities, <br />showcasing simple two-way video chat functionality.</p>
          </div>
